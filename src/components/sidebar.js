                ...
                <section className="sidebar">
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <a href="pages/widgets.html">
                            <i className="fa fa-th"></i> <span>Invitation Code</span>
                            <span className="pull-right-container">
                        ...
                        <ul className="treeview-menu">
                            <li><a href="pages/charts/chartjs.html"><i className="fa fa-circle-o"></i>Notification</a></li>
                        ...
                        <li>
                        <ul className="treeview-menu">
                            <li><a href="pages/tables/simple.html"><i className="fa fa-circle-o"></i> Currated</a></li>
                            <li><a href="pages/tables/data.html"><i className="fa fa-circle-o"></i> Team</a></li>
                        </ul>
                        </li>
                        <li>
                        <a href="pages/calendar.html">
                            <i className="fa fa-calendar"></i> <span>DarkMode</span>
                            <span className="pull-right-container">
